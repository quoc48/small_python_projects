...
while True: # Keep asking until the player enter a number.
...
while True:     # Main program loop.
    ...
    # (i) EXPERIMENT: Add a cheat here that increases a snail's progress
    # if it has your name.

    time.sleep(0.5)     # (i)   EXPERIMENT: Try changing this value.

    # (i)   EXPERIMENT: What happens if you comment this line out?
    print('\n' * 40)
